...
function openSection(section) {
  ...
  break;
    ...
    case "mistakes":
      content.innerHTML = `
      <h2>🔍 ГРАМОТЕЙКА</h2>
      <p>здесь разбираем сложные случаи: «одеть» или «надеть»? 
      Кофе — он или оно? 
    ...
    case "mistakes":
      content.innerHTML = `
      <h2>🎮 СЛОВОЗОР</h2>
      <p>Игры для ума и души: викторины, квизы, словесные батлы и челленджи. 
    ...
    case "mistakes":
      ...
      <p>Обсуждаем книги, фильмы, современный сленг и всё, что делает наш язык живым. 
